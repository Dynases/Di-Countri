...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prImprimir()
        ...
        Dim diaExamenTeo As String = diaLiteralTeo + ": 07:30am".ToUpper
...
#Region "METODOS SOBRECARGADOS"
    ...
    Public Overrides Function _PMOGrabarRegistro() As Boolean
        ...
        Dim res As Boolean = L_prAlumnoCertiGrabar(tbNumi.Text, tbCi.Text, tbNombre.Text, tbApellidoP.Text, tbApellidoM.Text, tbFNac.Value.ToString("yyyy/MM/dd"), nomImg, IIf(tbEscuela.Value = True, 1, 0), IIf(tbEstado.Value = True, 1, 0), tbEscNumiAlum.Text, tbTelf.Text, tbCel.Text, numiInst, tbSuc.Value)
        If res Then
    ...
    Public Overrides Function _PMOModificarRegistro() As Boolean
        ...
        Else
            numiInst = 0
        End If
        Dim res As Boolean = L_prAlumnoCertiModificar(tbNumi.Text, tbCi.Text, tbNombre.Text, tbApellidoP.Text, tbApellidoM.Text, tbFNac.Value.ToString("yyyy/MM/dd"), nomImg, IIf(tbEscuela.Value = True, 1, 0), IIf(tbEstado.Value = True, 1, 0), tbEscNumiAlum.Text, tbTelf.Text, tbCel.Text, numiInst, tbSuc.Value)
        If res Then
            If IsNothing(vlImagen) = False Then
