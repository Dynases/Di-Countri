...
#Region "SOCIO PAGOS"
    ...
    Public Shared Function L_fnSocioVentaDicontaPagosGrabar(ByRef numiventa As String, numiSocio As Integer, total As Double, fecha As String) As Boolean
        Dim _resultado As Boolean
...
#Region "ALUMNNO CERTIFICACION"
    ...
    Public Shared Function L_prAlumnoCertiGrabar(ByRef _numi As String, _ci As String, _nom As String, _apellPat As String, _apellMat As String, _fNac As String, ByRef _foto As String, _escuela As String, _estado As String, _alumNumiEscuela As String, _telf As String, _cel As String, _numiInst As String, _numiSuc As String) As Boolean
        Dim _res As Boolean
    ...
    Public Shared Function L_prAlumnoCertiModificar(ByRef _numi As String, _ci As String, _nom As String, _apellPat As String, _apellMat As String, _fNac As String, ByRef _foto As String, _escuela As String, _estado As String, _alumNumiEscuela As String, _telf As String, _cel As String, _numiInst As String, _numiSuc As String) As Boolean
        Dim _res As Boolean
...
#Region "Bancos"
    Public Shared Function L_prBancoGeneral() As DataTable
        ...
        Return _Tabla
    End Function
    Public Shared Function L_prBancoGrabar(ByRef _canumi As String, _canombre As String, _cacuenta As String, _caobs As String) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)
        't.canumi , t.canombre, t.cacuenta, t.caobs, t.cafact, t.cahact, t.cauact 
    ...
    Public Shared Function L_prBancoModificar(ByRef _canumi As String, _canombre As String, _cacuenta As String, _caobs As String) As Boolean
        Dim _resultado As Boolean
        Dim _Tabla As DataTable
        Dim _listPalam As New List(Of Datos.DParametro)
        't.canumi , t.canombre, t.cacuenta, t.caobs, t.cafact, t.cahact, t.cauact 
